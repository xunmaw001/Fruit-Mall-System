...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">水果库评论表管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">水果库评论表管理</li>
								<li class="breadcrumb-item active">水果库评论表列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">水果库评论表列表</h3>							
	...
	<script>
		...
		var tableName = "discussshuiguoku";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("discussshuiguoku/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussshuiguoku/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("discussshuiguoku"+colName,"GET",{
				tableName: "discussshuiguoku",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
					return res.data.sum;
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"discussshuiguoku");
