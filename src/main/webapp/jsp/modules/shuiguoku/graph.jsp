...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">水果库统计</li>
							</ol>
						</div>
					</div>
				</div>
	...
	$.ajax({ 
		type: "GET",
		url: baseUrl+"value/shuiguoku/"+xColumnName+'/'+yColumnName,
		data:{ },
	...
	function group(colName){
		$.ajax({ 
			type: "GET",
			url: baseUrl+"group/shuiguoku/"+colName,
			data:{	tableName: "shuiguoku",
					columnName: colName
					},
			beforeSend: function(xhr) {
				xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
