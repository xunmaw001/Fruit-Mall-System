...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in shuiguokuRecommend" v-bind:key="index">
                <a target="_self" :href="'../shuiguoku/detail.jsp?id='+item.id">
                  <div class="posi-img">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in shuiguokuList" v-bind:key="index">
                <a target="_self" :href="'../shuiguoku/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.tupian?item.tupian.split(',')[0]:''" width="385" height="220" />
                  </div>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`shuiguoku/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shuiguokuRecommend = res.data.list;
      });

      http.request(`shuiguoku/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shuiguokuList = res.data.list;
      });
    });
  </script>
</body>
